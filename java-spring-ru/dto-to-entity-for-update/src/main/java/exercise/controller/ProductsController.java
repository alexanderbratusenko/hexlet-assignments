...
public class ProductsController {
    ...
    public ProductDTO update(@RequestBody ProductUpdateDTO productData, @PathVariable long id) {
        var exist = productRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Product with id " + id + " not found"));

        var mapped = toEntity(productData, exist);
        var updated = productRepository.save(mapped);
